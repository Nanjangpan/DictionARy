...
#### 시연 이미지
  ...
  Unity 안에서 뷰포리아 엔진을 이용해 글자카드 인식을 하고 그 위에 카드의 이미지와 발음기호가 뜨게끔 설정하였다. 자모음이 설정한 일정 경계 안에 위치할 때 한글의 결합 원리에 따라 음절이 완성된다.  아래 이미지에서 반투명 박스 안에 ‘word : 항’ 이라고 출력된 것을 볼 수 있다. 오른쪽 ‘워’와 같이 모음의 결합이 먼저 필요한 글자나, ㅀ, ㅆ 등 자음의 반복의 경우에도 명확히 인식할 수 있도록 개선하였다. 알고리즘 설계에 따라 모음들끼리 먼저 결합된 후, ‘ㅝ’ 와 ‘ㅇ’의 거리가 결합조건에 부합하여 ‘워’ 가 출력된다.


<img src="https://user-images.githubusercontent.com/50066454/80899440-26b9dd00-8d4b-11ea-9b0f-e644de225a13.gif" width="40%" height="40%"> <img src="https://user-images.githubusercontent.com/50066454/80899450-40f3bb00-8d4b-11ea-9a6c-465090684c34.gif" width="40%" height="40%"></img>

<br>
  단어 인식 후, 3d 애셋이 화면에 출력되도록 했다. 아래 예시는 ‘곰’ 을 인식했을 때 곰의 3d 형상을 띄운 모습이다. <br>
<img src="https://user-images.githubusercontent.com/50066454/80899454-4e10aa00-8d4b-11ea-8a37-4124bf589930.gif" width="50%" height="50%"></img>
<br>

안드로이드로 환경을 전환하였고, 위의 이미지와 같이 카드의 위치에 따라 결합되거나 무시되게끔 하였다. 앞으로는 UI 를 안드로이드와 교육환경에 맞도록 개선할 예정이다. 또한 자모음 인식을 의미하는 적록색 구가 음절로 변환 시 합쳐지도록 구현할 예정이다. <br>
<img src="https://user-images.githubusercontent.com/50066454/80899458-5832a880-8d4b-11ea-801d-d36834dfd85a.jpg" width="30%" height="30%"> <img src="https://user-images.githubusercontent.com/50066454/80899462-608ae380-8d4b-11ea-86b3-481099034a39.jpg" width="30%" height="30%"></img>
##
